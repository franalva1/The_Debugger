...
/*
 * Swaps the current buffer to the interrupt buffer
 */
void gl_swap_interrupt_buffer(void);

/*
 * Draws a white square in the interrupt buffer, centered at (x, y) with side 
 * length width.
 * 
...
/*
 * Clears the interrupt buffer to a solid color
 * 
 * @param c  color to set screen
 */
